...
var VLIWOperation_1 = require("./VLIWOperation");
var VLIWParser = /** @class */ (function () {
    ...
    VLIWParser.Parse = function (input, code) {
        ...
        for (var i = 0; i < splittedInputInRows.length; i++) {
            instructions[i] = new LargeInstructions_1.LargeInstruction();
            ...
            if (instructionsAmount > 0) {
                for (var j = 0; j < instructionsAmount; j++) {
                    ...
                    var operation = new VLIWOperation_1.VLIWOperation(null, code.instructions[index], functionalUnitType, functionalUnitIndex);
