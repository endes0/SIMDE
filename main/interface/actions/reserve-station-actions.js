...
exports.NEXT_RESERVE_STATION_CYCLE = 'NEXT_RESERVE_STATION_CYCLE';
function nextReserveStationCycle(data) {
    return {
        type: exports.NEXT_RESERVE_STATION_CYCLE,
        value: data.map(function (element) { return mapReserveStationEntry(element); })
    };
}
exports.nextReserveStationCycle = nextReserveStationCycle;
