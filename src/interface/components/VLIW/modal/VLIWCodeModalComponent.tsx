...
import { toggleVliwCodeModal } from '../../../actions/modals';
...
export class VLIWCodeModalComponent extends React.Component<any, any> {
    ...
    close() {
        this.props.actions.toggleVliwCodeModal(false);
    };
    ...
    render() {
        return (<Modal className="smd-load_modal" show={this.props.isVliwCodeModalOpen} onHide={this.close}>
...
const mapStateToProps = state => {
    return {
        isVliwCodeModalOpen: state.isVliwCodeModalOpen,
    }
}

function mapDispatchToProps(dispatch) {
    return { actions: bindActionCreators({toggleVliwCodeModal}, dispatch)};
}

export default translate('common', { wait: true })(connect(mapStateToProps, mapDispatchToProps)(VLIWCodeModalComponent));
