...
import { NEXT_PREFETCH_CYCLE, NEXT_DECODER_CYCLE, NEXT_JUMP_TABLE_CYCLE, FUNCTIONAL_UNIT_CYCLE, HEADER_TABLE_CYCLE, TABLE_CYCLE, NEXT_RESERVE_STATION_CYCLE, NEXT_REORDER_BUFFER_MAPPER_CYCLE, NEXT_REORDER_BUFFER_CYCLE, NEXT_REGISTERS_CYCLE, NEXT_MEMORY_CYCLE, NEXT_CYCLE, SUPERESCALAR_LOAD, VIEW_BASIC_BLOCKS, COLOR_CELL } from '../actions';
import { TOGGLE_LOAD_MODAL, TOGGLE_AUTHOR_MODAL, TOGGLE_OPTIONS_MODAL, TOGGLE_SUPER_CONFIG_MODAL, TOGGLE_VLIW_CONFIG_MODAL, TOGGLE_SUPERESCALAR_LOAD_CONTENT_MODAL, TOGGLE_VLIW_LOAD_CONTENT_MODAL, TOGGLE_BATCH_MODAL, DISPLAY_BATCH_RESULTS, CLEAR_BATCH_RESULTS } from '../actions/modals';
...
import { NEXT_NAT_FPR_CYCLE, ADD_NAT_FPR_INTERVAL, ADD_NAT_GPR_INTERVAL, ADD_PREDICATE_INTERVAL, REMOVE_NAT_GPR_INTERVAL, REMOVE_PREDICATE_INTERVAL, REMOVE_NAT_FPR_INTERVAL, NEXT_NAT_GPR_CYCLE, NEXT_PREDICATE_CYCLE } from '../actions/predicate-nat-actions';
export var MAX_HISTORY_SIZE = 10;
export var PREDICATE_SIZE = 64;
...
export function SuperescalarReducers(state, action) {
