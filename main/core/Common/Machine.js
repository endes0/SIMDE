...
var MachineStatus_1 = require("./MachineStatus");
...
var Machine = /** @class */ (function () {
    function Machine() {
        ...
        // Init val
        this.status = new MachineStatus_1.MachineStatus();
        this.memory = new Memory_1.Memory();
        this._gpr = new Register_1.Register();
        this._fpr = new Register_1.Register();
        this.functionalUnit = new Array(FunctionalUnit_1.FUNCTIONALUNITTYPESQUANTITY);
    ...
    Machine.prototype.init = function (reset) {
        ...
        for (var i = 0; i < FunctionalUnit_1.FUNCTIONALUNITTYPESQUANTITY; i++) {
            ...
            for (var j = 0; j < this.functionalUnitNumbers[i]; j++) {
                this.functionalUnit[i][j] = new FunctionalUnit_1.FunctionalUnit();
                this.functionalUnit[i][j].type = FunctionalUnit_1.FunctionalUnitType[FunctionalUnit_1.FunctionalUnitType[i]];
    ...
    Machine.NGP = Constants_1.MACHINE_REGISTER_SIZE;
    Machine.NFP = Constants_1.MACHINE_REGISTER_SIZE;
    return Machine;
}());
